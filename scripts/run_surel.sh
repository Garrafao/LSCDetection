...
# SURel parameters
parameterfile=scripts/parameters_surel.sh # corpus- and testset-specific parameter specifications

## Get predictions from models ##
# All models with similarity measures
globalmatrixfolderprefix=matrices/surel_sim # parent folder for matrices
globalresultfolderprefix=results/surel_sim # parent folder for results
...
globalmatrixfolderprefix=matrices/surel_disp # parent folder for matrices
globalresultfolderprefix=results/surel_disp # parent folder for results
source $parameterfile # get corpus- and testset-specific parameters
...
globalmatrixfolderprefix=matrices/surel_wi # parent folder for matrices
globalresultfolderprefix=results/surel_wi # parent folder for results
source $parameterfile # get corpus- and testset-specific parameters
